...
export FABRIC_CFG_PATH=/workspaces/UniversityConsortium/config/cit

# Address of the peer
export CORE_PEER_ADDRESS="cit.$1.edu:7051"

# Local MSP for the admin - Commands need to be executed as org admin
export CORE_PEER_MSPCONFIGPATH="/workspaces/UniversityConsortium/config/crypto-config/peerOrganizations/$1.edu/users/Admin@$1.edu/msp"
